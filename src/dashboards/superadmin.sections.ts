...
export const platformGovernanceSection: DashboardSection = {
...
export const partnersTenantsSection: DashboardSection = {
  id: 'partners-tenants',
...
export const pricingPlansSection: DashboardSection = {
  id: 'pricing-plans',
  label: 'Pricing & Plans',
  icon: 'credit-card',
  order: 3,
...
export const incentivesAffiliatesSection: DashboardSection = {
...
export const featureFlagsSection: DashboardSection = {
...
export const brandingWhitelabelSection: DashboardSection = {
...
export const infrastructureSection: DashboardSection = {
...
export const auditComplianceSection: DashboardSection = {
  id: 'audit-compliance',
...
export const aiAutomationSection: DashboardSection = {
  id: 'ai-automation',
  label: 'AI / Automation',
  icon: 'cpu',
  order: 9,
...
export const allSuperAdminSections: DashboardSection[] = [
  platformGovernanceSection,
  partnersTenantsSection,
  pricingPlansSection,
  incentivesAffiliatesSection,
  featureFlagsSection,
  brandingWhitelabelSection,
